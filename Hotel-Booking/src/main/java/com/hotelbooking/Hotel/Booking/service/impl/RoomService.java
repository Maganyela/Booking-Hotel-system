...
import com.hotelbooking.Hotel.Booking.service.AwsS3Service;
...
public class RoomService implements IRoomService {
    ...
    public Response getAvailableRoomsByDataAndType(LocalDate checkInDate, LocalDate checkOutDate, String roomType) {
        ...
        try {
           List<Room> availableRooms = roomRepository.findAvailableRoomNByDatesAndTypes(checkInDate, checkOutDate, roomType);
